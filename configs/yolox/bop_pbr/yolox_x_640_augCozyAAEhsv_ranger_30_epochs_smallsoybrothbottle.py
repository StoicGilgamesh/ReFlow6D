...
# datasets
DATASETS.TRAIN = ["smallsoybrothbottle_train_pbr"]
#DATASETS.TRAIN = ["bottle_arch_train_pbr"]
DATASETS.TEST = ["smallsoybrothbottle_bop_test"]
...
dataloader.train.aug_wrapper.COLOR_AUG_PROB = 0.0
...
# hsv color aug
dataloader.train.aug_wrapper.AUG_HSV_PROB = 0.0
dataloader.train.aug_wrapper.HSV_H = 0.0
dataloader.train.aug_wrapper.HSV_S = 0.0
dataloader.train.aug_wrapper.HSV_V = 0.0
...
train.total_epochs = 80
train.no_aug_epochs = 78
