...
OUTPUT_DIR = "output/gdrn/mcup31/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_mcup31"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["mcup31_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["mcup31_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/mcup31/test/test_bboxes/yolox_x_640_mcup31.json",),
