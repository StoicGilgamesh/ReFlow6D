...
OUTPUT_DIR = "output/gdrn/mugarch/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_mugarch"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["mugarch_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["mugarch_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/mugarch/test/test_bboxes/yolox_x_640_mugarch.json",),
