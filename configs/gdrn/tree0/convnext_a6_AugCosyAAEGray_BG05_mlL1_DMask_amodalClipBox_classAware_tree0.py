...
OUTPUT_DIR = "output/gdrn/tree0/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tree0"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["tree0_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["tree0_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/tree0/test/test_bboxes/yolox_x_640_tree0.json",),
