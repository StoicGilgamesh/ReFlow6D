...
OUTPUT_DIR = "output/gdrn/bottle2/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_bottle2"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["bottle2_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["bottle2_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/bottle2/test/test_bboxes/yolox_x_640_bottle2.json",),
