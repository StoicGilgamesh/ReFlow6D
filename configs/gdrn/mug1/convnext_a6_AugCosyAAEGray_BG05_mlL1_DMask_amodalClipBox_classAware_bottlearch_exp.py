...
OUTPUT_DIR = "output/gdrn/bottlearch_fullimg/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_bottlearch"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["bottlearch_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["bottlearch_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/bottlearch/test/test_bboxes/yolox_x_640_bottlearch.json",),
