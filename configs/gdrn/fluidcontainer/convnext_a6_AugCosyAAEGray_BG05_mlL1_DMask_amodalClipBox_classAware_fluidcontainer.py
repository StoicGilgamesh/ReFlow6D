...
OUTPUT_DIR = "output/gdrn/fluidcontainer/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_fluidcontainer"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
#    TRAIN = ["train"],
    ...
    DET_FILES_TEST=("datasets/BOP_DATASETS/fluidcontainer/test/test_bboxes/yolox_x_640_fluidcontainer.json",),
