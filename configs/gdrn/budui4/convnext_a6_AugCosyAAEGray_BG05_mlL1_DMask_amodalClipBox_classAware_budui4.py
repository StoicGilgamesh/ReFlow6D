...
OUTPUT_DIR = "output/gdrn/budui4/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_budui4"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["budui4_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["budui4_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/budui4/test/test_bboxes/yolox_x_640_budui4.json",),
