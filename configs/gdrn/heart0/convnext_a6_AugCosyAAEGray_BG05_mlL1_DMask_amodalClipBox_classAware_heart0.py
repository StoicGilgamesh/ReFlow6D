...
OUTPUT_DIR = "output/gdrn/heart0/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_heart0"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["heart0_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["heart0_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/heart0/test/test_bboxes/yolox_x_640_heart0.json",),
