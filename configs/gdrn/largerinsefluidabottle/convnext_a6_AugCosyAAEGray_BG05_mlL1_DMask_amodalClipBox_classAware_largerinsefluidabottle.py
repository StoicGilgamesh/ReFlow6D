...
OUTPUT_DIR = "output/gdrn/largerinsefluidabottle/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_largerinsefluidabottle"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["largerinsefluidabottle_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["largerinsefluidabottle_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/largerinsefluidabottle/test/test_bboxes/yolox_x_640_largerinsefluidabottle.json",),
...
VAL = dict(
    DATASET_NAME="largerinsefluidabottle",
