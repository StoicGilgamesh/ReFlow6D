...
OUTPUT_DIR = "output/gdrn/bottle/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_bottle"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN = ["bottle_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["bottle_bop_test"],
#    TEST = ["test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/bottle/test/test_bboxes/yolox_x_640_tracebot_bottle.json",),
