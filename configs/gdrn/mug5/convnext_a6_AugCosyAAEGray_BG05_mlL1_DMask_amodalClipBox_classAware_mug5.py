...
OUTPUT_DIR = "output/gdrn/mug5/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_mug5"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["mug5_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["mug5_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/mug5/test/test_bboxes/yolox_x_640_mug5.json",),
