...
OUTPUT_DIR = "output/gdrn/zhuixin/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_zhuixin"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["zhuixin_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["zhuixin_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/zhuixin/test/test_bboxes/yolox_x_640_zhuixin.json",),
