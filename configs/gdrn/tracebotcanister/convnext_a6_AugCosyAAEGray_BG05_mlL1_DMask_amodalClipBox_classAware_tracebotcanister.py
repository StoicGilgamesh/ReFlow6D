...
OUTPUT_DIR = "output/gdrn/tracebotcanister/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tracebotcanister"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
#     ANNEAL_POINT=0.5,# 0.72
#     OPTIMIZER_CFG=dict(_delete_=True, type="Ranger", lr=8e-6, weight_decay=0.01),#lr=8e-4
#     WEIGHT_DECAY=0.0,
#     WARMUP_FACTOR=0.005,
#     WARMUP_ITERS=1000,
# )
...
DATASETS = dict(
    TRAIN = ["tracebotcanister_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["tracebotcanister_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/tracebotcanister/test/test_bboxes/yolox_x_640_tracebotcanister.json",),
