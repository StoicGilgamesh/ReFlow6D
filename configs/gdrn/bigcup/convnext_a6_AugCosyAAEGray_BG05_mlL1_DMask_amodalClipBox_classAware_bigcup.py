...
OUTPUT_DIR = "output/gdrn/bigcup/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_bigcup"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["bigcup_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["bigcup_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/bigcup/test/test_bboxes/yolox_x_640_bigcup.json",),
