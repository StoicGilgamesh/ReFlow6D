...
OUTPUT_DIR = "output/gdrn/tracebotstripecanister/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tracebotstripecanister"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["tracebotstripecanister_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["tracebotstripecanister_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/tracebotstripecanister/test/test_bboxes/yolox_x_640_tracebotstripecanister.json",),
...
VAL = dict(
    DATASET_NAME="tracebotstripecanister",
