...
OUTPUT_DIR = "output/gdrn/mmmmm1/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_mmmmm1"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["mmmmm1_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["mmmmm1_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/mmmmm1/test/test_bboxes/yolox_x_640_mmmmm1.json",),
