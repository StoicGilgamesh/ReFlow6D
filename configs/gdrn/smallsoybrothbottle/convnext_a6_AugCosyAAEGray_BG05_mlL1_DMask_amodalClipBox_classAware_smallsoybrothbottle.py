...
OUTPUT_DIR = "output/gdrn/smallsoybrothbottle/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_smallsoybrothbottle"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.0,
...
DATASETS = dict(
    TRAIN = ["smallsoybrothbottle_train_pbr"],
#    TRAIN = ["train"],
    TEST = ["smallsoybrothbottle_bop_test"],
    DET_FILES_TEST=("datasets/BOP_DATASETS/smallsoybrothbottle/test/test_bboxes/yolox_x_640_smallsoybrothbottle.json",),
...
VAL = dict(
    DATASET_NAME="smallsoybrothbottle",
