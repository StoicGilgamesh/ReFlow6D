...
near = 0.25
far = 6.0
data_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/mug1/train_pbr"))

cls_indexes = [_idx for _idx in sorted(idx2class.keys())]
cls_names = [idx2class[cls_idx] for cls_idx in cls_indexes]
model_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/mug1/models"))
