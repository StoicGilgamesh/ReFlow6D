...
near = 0.25
far = 6.0
data_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/bottle1/train_pbr"))

cls_indexes = [_idx for _idx in sorted(idx2class.keys())]
cls_names = [idx2class[cls_idx] for cls_idx in cls_indexes]
model_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/bottle1/models"))
                ...
                for anno_i, anno in enumerate(annos):
                    ...
                    if mask.sum() == 0:  # NOTE: this should be ignored at training phase
                        ...
                        if VIS:
                            ...
                            #np.save("/RoadmapWithStefan/gdrnpp_bop2022/core/gdrn_modeling/tools/bottle1/bgr_gl.npy",bgr_gl[:, :, [2, 1, 0]])
                            #np.save("/RoadmapWithStefan/gdrnpp_bop2022/core/gdrn_modeling/tools/bottle1/im.npy", im[:, :, [2, 1, 0]])
                            #np.save("/RoadmapWithStefan/gdrnpp_bop2022/core/gdrn_modeling/tools/bottle1/mask_gt.npy", mask_gt)
                            #np.save("/RoadmapWithStefan/gdrnpp_bop2022/core/gdrn_modeling/tools/bottle1/mask_visib_gt.npy", mask_visib_gt)
                            show_titles = [
                                "bgr_gl",
                                "im",
                                "mask_gt",
