...
class ConvPnPNet(nn.Module):
    ...
    ################################################################################### ABALATION STUDIES ##########################################
    def forward(self, region, flow, rho, extents=None, mask_attention=None):
    # def forward(self, region, extents=None, mask_attention=None):
    ################################################################################### ABALATION STUDIES ##########################################
        """
        Args:
        ...
        ################################################################################### ABALATION STUDIES ##########################################
        x = torch.cat([region, flow, rho,], dim=1)
        # x = torch.cat([region,], dim=1)
        ################################################################################### ABALATION STUDIES ##########################################
