...
class FLUIDCONTAINER_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get(
            "dataset_root",
            osp.join(DATASETS_ROOT, "BOP_DATASETS/fluidcontainer/train_pbr"),
        )
...
fluidcontainer_model_root = "BOP_DATASETS/fluidcontainer/models/"
################################################################################


SPLITS_FLUIDCONTAINER_PBR = dict(
    fluidcontainer_train_pbr=dict(
        name="fluidcontainer_train_pbr",
        objs=ref.fluidcontainer.objects,  # selected objects
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/fluidcontainer/train_pbr"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/fluidcontainer/models"),
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/fluidcontainer/train_pbr/xyz_crop"),
...
for obj in ref.fluidcontainer.objects:
    for split in ["train_pbr"]:
        name = "fluidcontainer_{}_{}".format(obj, split)
        ...
        if name not in SPLITS_FLUIDCONTAINER_PBR:
            SPLITS_FLUIDCONTAINER_PBR[name] = dict(
                name=name,
...
def register_with_name_cfg(name, data_cfg=None):
    ...
    if name in SPLITS_FLUIDCONTAINER_PBR:
        used_cfg = SPLITS_FLUIDCONTAINER_PBR[name]
    else:
        assert data_cfg is not None, f"dataset name {name} is not registered"
        used_cfg = data_cfg
    DatasetCatalog.register(name, FLUIDCONTAINER_PBR_Dataset(used_cfg))
    # something like eval_types
    MetadataCatalog.get(name).set(
        id="fluidcontainer_pbr",  # NOTE: for pvnet to determine module
...
def get_available_datasets():
    return list(SPLITS_FLUIDCONTAINER_PBR.keys())
...
if __name__ == "__main__":
    ...
    Usage:
        python -m this_module fluidcontainer_train_pbr
    """
