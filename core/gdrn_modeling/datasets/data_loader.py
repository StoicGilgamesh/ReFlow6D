...
class GDRN_DatasetFromList(Base_DatasetFromList):
    ...
    def read_data_train(self, dataset_dict):
        ...
        #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_/roi_mask_obj_dataloader.npy",roi_mask_obj)
        #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_/roi_mask_full_dataloader.npy",roi_mask_full)
        #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_/xyz_dataloader.npy",xyz)
        ...
        #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_/roi_xyz_dataloader.npy",roi_xyz)
...
################## REMOVE THIS AFTER REGION ONLY EXPERIMENTATION ###########################################################################
            src = roi_region.copy()
            experiment_roi_region = np.zeros((65, 64, 64))
            for i, img in enumerate(experiment_roi_region):
                experiment_roi_region[i][src == i] = 1.0
################## REMOVE THIS AFTER REGION ONLY EXPERIMENTATION ###########################################################################
                
            # dataset_dict["roi_region"] = torch.as_tensor(roi_region.astype(np.int32)).contiguous()
            dataset_dict["roi_region"] = torch.as_tensor(experiment_roi_region.astype(np.float32)).contiguous()
            #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_exp/roi_region_dataloader.npy",roi_region)
            #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_exp/roi_xyz_dataloader.npy",roi_xyz)
        ...
        #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_exp/roi_img_dataloader.npy", roi_img.astype("float32"))
        #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_exp/roi_mask_trunc_dataloader.npy", roi_mask_trunc.astype("float32"))
        #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_exp/roi_mask_visib_dataloader.npy", roi_mask_visib.astype("float32"))
        #np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_exp/roi_mask_obj_dataloader.npy", roi_mask_obj.astype("float32"))
    ...
    def read_data_test(self, dataset_dict):
        ...
        # np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_/xyz_crop_test_dataloader.npy",xyz_crop)
        # np.save("/RoadmapWithStefan/gdrnpp_bop2022/debug_/xyz_test_dataloader.npy",xyz)
...
def build_gdrn_test_loader(cfg, dataset_name, train_objs=None, sampler=None, batch_size=1, pin_memory=False):
    ...
    if cfg.MODEL.LOAD_DETS_TEST:
        ...
        #print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT@@@@@@@@@@@@@@@@@@@@@@@@@: ", [cfg.DATASETS.PROPOSAL_FILES_TEST[list(cfg.DATASETS.TEST).index(dataset_name)]])
    ...
    #print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT@@@@@@@@@@@@@@@@@@@@@@@@@: ", dataset_dicts)
