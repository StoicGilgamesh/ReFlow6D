...
# TRACEBOT
# ---------------------------------------------------------------- #
dataset_root = osp.join(bop_root, "fluidcontainer")
...
camera_matrix = np.array([[432.04449462890625, 0.0, 426.8683776855469], [0.0, 431.73626708984375, 236.82254028320312], [0, 0, 1]])
