...
# TRACEBOT
# ---------------------------------------------------------------- #
dataset_root = osp.join(bop_root, "heart0")
...
camera_matrix = np.array([[675.6171264648438, 0.0, 632.1181030273438],[0.0, 675.6171264648438, 338.2853698730469],[0.0, 0.0, 1.0]])
