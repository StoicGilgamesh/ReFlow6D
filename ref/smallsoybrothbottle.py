...
# TRACEBOT
# ---------------------------------------------------------------- #
dataset_root = osp.join(bop_root, "smallsoybrothbottle")
...
camera_matrix = np.array([[909.9260796440973,
  0.0,
  643.5625], [0.0,
  907.9168585002319,
  349.017181282838], [0, 0, 1]])
